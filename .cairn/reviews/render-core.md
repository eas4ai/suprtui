...
findings:
  ...
  - open: evidence recording blocked by the truthful LOOP-035 scope flag (`tests/buffer_core.rs` changed in this window and belongs to buffer-core); red stands until Current advances past that change
